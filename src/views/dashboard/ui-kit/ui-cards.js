          ...
          <Row>
            ...
            <Col sm="12">
              ...
              <div
                ...
                style={{ position: "relative", height: "812px" }}
              >
                <Col
                  sm="6"
                  lg="4"
                ...
                <Col
                  sm="6"
                  lg="4"
                  style={{ position: "absolute", left: "33.3328%", top: "0px" }}
                >
                  <Card className="mb-3">
                ...
                <Col
                  sm="6"
                  lg="4"
                  style={{ position: "absolute", left: "66.6656%", top: "0px" }}
                >
                  <Card className="mb-3">
                    <Card.Img variant="top" src={img07} alt="#" />
                    <Card.Body>
                ...
                <Col
                  sm="6"
                  lg="4"
                  style={{ position: "absolute", left: "0%", top: "439.406px" }}
                >
