            ...
            <Col sm="12" lg="6">
              <Card>
                ...
                <Card.Body>
                  ...
                  <Alert
                    variant="alert alert-solid alert-info"
                    className="mb-3"
                    show={showA6}
                    role="alert"
          ...
          <Row>
            <Col sm="12">
              <Card>
                ...
                <Card.Body>
                  <Alert
                    variant="alert alert-left alert-success  mb-3"
                    show={showA9}
                    role="alert"
                  ...
                  <Alert
                    variant="alert alert-top alert-info mb-3"
                    show={showA10}
                    role="alert"
                  ...
                  <Alert
                    variant="alert alert-right alert-warning   mb-3"
                    show={showA11}
                    role="alert"
                  ...
                  <Alert
                    variant="alert alert-bottom alert-danger  mb-3"
                    show={showA12}
                    role="alert"
            ...
            <Col lg={12}>
              <Card>
                ...
                <Alert
                  variant="warning rounded-0   mb-3"
                  show={showA13}
                  role="alert"
